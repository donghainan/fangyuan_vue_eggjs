  ...
  <div class="header">
    ...
    >
      ...
      <ul class="popover-ul systemMsgUl">
        <!-- 
                ...
                cont2
                -->
        <li class="sysmsgNum parl">
          系统消息：<span>({{ newSystemInfo }})</span>
        </li>
      ...
      <span class="systemBom" v-if="serverDecs == '专业版'">
        <p>
          您的系统版本为{{ serverDecs }}（免费100天）
          <a @click.stop="xfsj" class="renewal knowMore"
            >联系客服<i class="el-icon-arrow-right"></i
          ></a>
        </p>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="wxtsDialog = !wxtsDialog"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="dialogtwo = !dialogtwo"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="dialogthree = !dialogthree"
          >确 定</el-button
        >
      </span>
    </el-dialog>
