...
module.exports = (app) => {
	...
	const Wxhouse = app.model.define(
		'wxhouse',
		{
			...
			houseNo: { type: STRING, comment: '房源编号' },
			houseRecommend: { type: INTEGER, comment: '房源推荐等级' },
			houseInfo: { type: STRING(1234), comment: '房源信息' },
			houseHighlights: { type: STRING(1234), comment: '房源亮点' },
			...
			houseArea: { type: STRING, comment: '面积' },
			houseFloor: { type: STRING, comment: '楼层' },
			houseFloorAllocation: { type: STRING, comment: '房屋配置' },
